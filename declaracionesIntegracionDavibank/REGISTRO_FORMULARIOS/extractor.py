...
# Estructura vertical: un renglón por concepto, sin desagregar
# por tipo de persona.
# ============================================================
...
# (nro_renglon, etiqueta, seccion, editable)
RENGLONES_F300 = [
    # ---------- Ingresos ----------
    ...
    (46, "De bienes y servicios gravados provenientes de Zonas Francas",      "COMPRAS_IMPORTACION", "SI"),
    ...
    (60, "Sobre A.I.U en operaciones gravadas (base gravable especial)",      "IMPUESTO_GENERADO", "SI"),
    ...
    (70, "De bienes y servicios gravados provenientes de Zonas Francas",      "IMPUESTO_DESCONTABLE", "SI"),
    ...
    (91, "Saldo a favor susceptible de ser devuelto y/o compensado a imputar en el período siguiente",
                                                                              "CONTROL_SALDOS", "SI"),
    (92, "Saldo a favor sin derecho a dev. y/o compensación susceptible de ser imputado en el período siguiente",
                                                                              "CONTROL_SALDOS", "SI"),
    (93, "Total saldo a favor a imputar al periodo siguiente",                "CONTROL_SALDOS", "NO"),
...
#BLOQUE 4 
# ============================================================
# BLOQUE 4 — Construcción del dataset del F300
# ============================================================
registros = []
...
for nro, etiqueta, seccion, editable in RENGLONES_F300:
    registros.append({
        ...
        "nro_renglon":    nro,
        "etiqueta":       etiqueta,
        "tipo_persona":   "",            # el IVA no desagrega por tipo de persona
        "tipo_valor":     "VALOR",
